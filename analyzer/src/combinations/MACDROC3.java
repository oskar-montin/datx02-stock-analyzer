...
public class MACDROC3 implements AnalysisMethod {
	...
	public MACDROC3(Collection<DailyData> queue, 
	...
	public Signal getSignal() {
		if(macd.getMACD().peek().getValue() < 0 && roc.getSignal() == Signal.SELL)
			return Signal.SELL;
		else if(macd.getMACD().peek().getValue() > 0 && roc.getSignal() == Signal.BUY)
			return Signal.BUY;
		else
			return Signal.NONE;
	}
