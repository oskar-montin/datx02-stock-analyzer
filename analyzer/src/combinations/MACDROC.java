...
public class MACDROC implements AnalysisMethod {
	...
	public MACDROC(Collection<DailyData> queue, 
	...
	public Signal getSignal() {
		if(macd.getMACDFiltered().peek().getValue() < 0 && roc.getSignal() == Signal.SELL)
			return Signal.SELL;
		else if(macd.getMACDFiltered().peek().getValue() > 0 && roc.getSignal() == Signal.BUY)
			return Signal.BUY;
		else
			return Signal.NONE;
	}
