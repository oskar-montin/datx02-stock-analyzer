...
public class MACDCMF3 implements AnalysisMethod {
	...
	public MACDCMF3(Collection<DailyData> queue, 
	...
	public Signal getSignal() {
		if(macd.getMACDFiltered().peek().getValue() < 0 && cmf.getSignal() == Signal.SELL)
			return Signal.SELL;
		else if(macd.getMACDFiltered().peek().getValue() > 0 && cmf.getSignal() == Signal.BUY)
			return Signal.BUY;
		else
			return Signal.NONE;
	}
